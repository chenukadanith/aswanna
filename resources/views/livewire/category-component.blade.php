                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-style inline-round ">
                            <li class="list-item"><a class="filter-link active" href="#">0.5kg</a></li>
                            <li class="list-item"><a class="filter-link " href="#">1kg</a></li>
                            <li class="list-item"><a class="filter-link " href="#">2kg</a></li>
                            <li class="list-item"><a class="filter-link " href="#">5kg</a></li>
                        </ul>
